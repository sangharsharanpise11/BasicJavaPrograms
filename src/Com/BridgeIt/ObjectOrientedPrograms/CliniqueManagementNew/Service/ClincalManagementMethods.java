package Com.BridgeIt.ObjectOrientedPrograms.CliniqueManagementNew.Service;
import java.io.File;
...
import Com.BridgeIt.ObjectOrientedPrograms.CliniqueManagementNew.Model.Appointment;
import Com.BridgeIt.ObjectOrientedPrograms.CliniqueManagementNew.Model.Doctor;
import Com.BridgeIt.ObjectOrientedPrograms.CliniqueManagementNew.Model.Patient;
...
public void deletePatient() throws JsonParseException, JsonMappingException, IOException {
	...
	if(patientFileObject.length()==0)
	{
		...
		OopsUtility.writeObjectToJson(patientArrayList, fileName+".json");
	}
}
...
public void appointment() throws JsonParseException, JsonMappingException, IOException {
	...
	if (appointmentFileObject.length() == 0) {
		...
		OopsUtility.writeObjectToJson(appointmentArray, fileName + ".json");
	} 
	else 
	{
